...
BEGIN
		...
		INSERT INTO [dbo].[EXAMEN_ANTROPOLOGICO]([FK_NUMERO_TRAZABLE_TORO],[PK_FECHA],[CONDICION_CORPORAL],[LIBIDO],[CAPACIDAD_DE_MONTA],[DESCANSO_SEXUAL],[PREPUCIO],[PENE],[TESTICULOS],[EPIDIDIMOS],[GLANDULAS_BULBOURETRALES],[PROSTATA],[VESICULAS_SEMINALES],[AMPULAS],[CIRCUNFERENCIA_ESCROTAL],[VOLUMEN_EYACULADO],[CONCENTRACION],[MOTILIDAD_MASAL],[MOTILIDAD_PROGRESIVA_RAPIDA],[MORFOLOGIA_NORMAL],[ANORMALIDADES_PRIMARIAS],[DANNOS_ACROSOMALES],[ANORMALIDADES_SECUNDARIAS],[TOTAL_ANORMALIDADES],[ANOMALIA_MAS_FRECUENTE],[LEUCOCITOS],[CEDULAS_EPITELEALES],[OBSERVACIONES],[SATISFACTORIO],[VETERINARIO],[Palpacion],[Ecografia],[VaginaArt],[ElectroEya],[Protusion])
